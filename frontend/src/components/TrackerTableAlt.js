...
export const TrackerTableAlt = () => {
  ...
  const filteredCompanies = useMemo(() => {
    return companies.filter((company) => {
      ...
      if (!passesRange(fin.grossMargin || 0, ff.grossMargin.valueMin, ff.grossMargin.valueMax)) return false;
          ...
          <thead>
            ...
            <tr>
              ...
              <th className="tracker-th" data-testid="col-gross-margin" style={{ minWidth: 160 }}>
                ...
                <MinMaxFilter labelPrefix="Value %" minVal={financialFilters.grossMargin.valueMin} maxVal={financialFilters.grossMargin.valueMax} onMinChange={v => setFinField('grossMargin','valueMin',v)} onMaxChange={v => setFinField('grossMargin','valueMax',v)} />
                ...
                return (
                  <tr key={company.id} className="tracker-row" onMouseEnter={() => setHoveredRow(company.id)} onMouseLeave={() => setHoveredRow(null)}>
                    ...
                    <td className="tracker-cell" style={{ borderLeft: '2px solid hsl(var(--border))', minWidth: 160 }}>
                      <FinancialCell value={fin.revenue} growth={fin.revenueGrowth || 0} format="inr" />
                    </td>
                    <td className="tracker-cell" style={{ minWidth: 160 }}>
                      <FinancialCell value={fin.grossMargin} growth={fin.grossMarginGrowth || 0} format="pct" />
                    </td>
                    <td className="tracker-cell" style={{ minWidth: 160 }}>
